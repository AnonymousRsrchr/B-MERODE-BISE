...
public class ShipmentDeliveryState extends ShipmentState {
  //========== Constructor ===========
  public ShipmentDeliveryState() {
  ...
  //--- Modifying Events ---
  @Override
  public void handle_EVshipmentDelivered(Shipment object, Context ctx) throws FailedEventHandlingException {
    ...
    ShipmentWaitingForConfirmationState newState = new ShipmentWaitingForConfirmationState();
    ...
    order_Order_Shipment.getCurrentState().handle_EVshipmentDelivered(order_Order_Shipment, ctx);
    //Carrier
    Carrier carrier_Carrier_Shipment = (Carrier)StubHelper.findBusinessObject(ctx, object.getCarrierId_Carrier_Shipment());
    carrier_Carrier_Shipment.getCurrentState().handle_EVshipmentDelivered(carrier_Carrier_Shipment, ctx);
  }
