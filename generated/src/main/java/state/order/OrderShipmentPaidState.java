...
public class OrderShipmentPaidState extends OrderState {
  //========== Constructor ===========
  public OrderShipmentPaidState() {
    super("shipmentPaid", StateType.ONGOING);
  }
  ...
  //--- Modifying Events ---
  @Override
  public void handle_EVinvoiceOrder(Order object, Context ctx) throws FailedEventHandlingException {
    ...
    OrderOrderInvoicedState newState = new OrderOrderInvoicedState();
    ...
    manufacturer_Manufacturer_Order.getCurrentState().handle_EVinvoiceOrder(manufacturer_Manufacturer_Order, ctx);
    //Customer
    Customer customer_Customer_Order = (Customer)StubHelper.findBusinessObject(ctx, object.getCustomerId_Customer_Order());
    customer_Customer_Order.getCurrentState().handle_EVinvoiceOrder(customer_Customer_Order, ctx);
  }
